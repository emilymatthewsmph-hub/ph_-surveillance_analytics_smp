...
1.2 Population Denominators ('population.csv')
...
1.3 Optional Synthetic Lab Data ('lab_results.csv')
...
2.1  Syndrome‑Flagged ED Visits ('ed_visits_classified.csv')
...
# 3. Final Outputs
3.1 Weekly Syndrome Counts ('weekly_syndrome_counts.csv')
...
3.2 Weekly Incidence Rates  ('weekly_incidence_rates.csv')
 | Column | Type | Description |
 |---------|-----|------------|
...
3.3 Weekly Surveillance Signals ('weekly_surveillance_signals.csv')
 | Column | Type | Description |
 |---------|-----|------------|
...
3.4 ILI Weekly Trend ('ili_weekly_trend.png')
